...
const port = process.env.PORT || 3007; // the fallback is for local development, heroku will use his own port, something like 12312, because imagine how many processes are running on the same machine there
...
server.use("/coments", commentsRoutes);
